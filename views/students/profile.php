				  ...
				  <div class="tab-pane active" id="tab_1">
					 <form class="form-horizontal">
						<div class="box-body">
							...
							<div class="form-group">
								<label for="start_date" class="col-sm-4 control-label">Tanggal Masuk <?=$this->session->userdata('school_level') >= 5 ? 'Kuliah' : 'Sekolah'?></label>
								<div class="col-sm-8">
								  <input readonly="true" type="text" class="form-control" id="start_date" value="<?=$query->start_date ? indo_date($query->start_date) : '';?>">
								</div>
							</div>
							<?php if ($this->session->userdata('school_level') < 5) { ?>
							<div class="form-group">
					...
					<div class="tab-pane" id="tab_2">
						<form class="form-horizontal">
							<div class="box-body">
								...
								<?php } ?>
								<div class="form-group">
									<label for="identity_number" class="col-sm-4 control-label">Nomor Induk <?=$this->session->userdata('school_level') >= 5 ? 'Mahasiswa' : 'Siswa' ?></label>
									<div class="col-sm-8">
				  ...
				  <div class="tab-pane" id="tab_3">
					...
					<div class="tab-pane" id="tab_6">
						<form class="form-horizontal">
							<div class="box-body">
								<div class="form-group">
									<label for="mileage" class="col-sm-4 control-label">Jarak Tempat Tinggal ke <?=$this->session->userdata('school_level') >= 5 ? 'Kampus' : 'Sekolah'?></label>
									<div class="col-sm-8">
									  <input type="text" class="form-control" id="mileage" value="<?=$query->mileage ? $query->mileage : '';?>">
									</div>
								</div>
								<div class="form-group">
									<label for="traveling_time" class="col-sm-4 control-label">Waktu Tempuh ke <?=$this->session->userdata('school_level') >= 5 ? 'Kampus' : 'Sekolah'?></label>
									<div class="col-sm-8">
