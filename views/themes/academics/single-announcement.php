            ...
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                <div class="row news-details-page-inner">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <?php if ($post_type == 'post' && file_exists('./media_library/announcement/large/' . $query->post_image)) { ?>
                            <div class="news-img-holder">
                                <img src="<?= base_url('media_library/announcement/large/' . $query->post_image) ?>" style="width: 100%; display: block;" class="img-responsive" alt="research">
                            </div>
                        <?php } ?>
