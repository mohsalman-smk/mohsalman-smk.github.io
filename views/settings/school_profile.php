...
<script type="text/javascript">
    DS.SchoolLevels = <?=datasource('school_levels')?>;
    DS.OwnershipStatus = <?=datasource('institution_lifters')?>;
    var _grid = 'OPTIONS',
        ...
        _form24 = _grid + '_FORM24', // Logo_primary
        _form25 = _grid + '_FORM25', // Logo_textprimary
        _form26 = _grid + '_FORM26'; // Logo_footer
        _form27 = _grid + '_FORM27'; // Logo_footer
        ...
        fields: [
            {
                ...
                renderer:function(row) {
                    ...
                    if (row.setting_variable == 'logo_primary') {
                        return UPLOAD(_form24 + '.OnUpload(' + row.id + ')', 'image', 'Upload Logo');
                    }
                    if (row.setting_variable == 'logo_textprimary') {
                        return UPLOAD(_form25 + '.OnUpload(' + row.id + ')', 'image', 'Upload Logo');
                    }
                    if (row.setting_variable == 'logo_footer') {
                        return UPLOAD(_form26 + '.OnUpload(' + row.id + ')', 'image', 'Upload Logo');
                    }
                    if (row.setting_variable == 'description_footer') {
            ...
            },
            {
                ...
                renderer:function(row) {
                    if (row.setting_variable == 'logo' || row.setting_variable == 'headmaster_photo' || row.setting_variable == 'logo_primary' || row.setting_variable == 'logo_textprimary' || row.setting_variable == 'logo_footer') {
    ...
    new FormBuilder( _form15 , {
        controller:'settings/school_profile',
        fields: [
            { label:'Kabupaten', name:'setting_value' }
        ]
    });
    ...
    new FormBuilder( _form24 , {
        controller:'settings/school_profile',
        fields: [
            { label:'Logo Primary', name:'setting_value' }
        ]
    });
    ...
    new FormBuilder( _form25 , {
        controller:'settings/school_profile',
        fields: [
            { label:'Logo Textprimary', name:'setting_value' }
        ]
    });
    ...
    new FormBuilder( _form26 , {
        controller:'settings/school_profile',
        fields: [
            { label:'Logo Footer', name:'setting_value' }
        ]
    });
    ...
    new FormBuilder( _form27, {
        controller:'settings/school_profile',
        fields: [
            { label:'Deskripsi Footer', name:'setting_value', type:'textarea' }
        ]
    });
