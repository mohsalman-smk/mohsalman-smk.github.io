...
<script type="text/javascript">
    ...
    var _grid = 'OPTIONS',
        ...
        _form14 = _grid + '_FORM14', // Latitude
        _form15 = _grid + '_FORM15', // Longitude
        _form16 = _grid + '_FORM16'; // recaptcha_status
        ...
        fields: [
            {
                ...
                renderer:function(row) {
                    ...
                    if (row.setting_variable == 'google_map_api_key') {
    ...
    new FormBuilder( _form7 , {
        controller:'settings/general',
        fields: [
            { label:'Google API Key', name:'setting_value' }
        ]
    });
    ...
    new FormBuilder( _form13 , {
        controller:'settings/general',
        fields: [
            { label:'Time Zone', name:'setting_value', type:'select', datasource:timezone_list }
        ]
    });
    ...
    new FormBuilder( _form14 , {
        controller:'settings/general',
        fields: [
            { label:'Latitude', name:'setting_value' }
        ]
    });
    ...
    new FormBuilder( _form15 , {
        controller:'settings/general',
        fields: [
            { label:'Longitude', name:'setting_value' }
        ]
    });
