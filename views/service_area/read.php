...
<script type="text/javascript">
    var _grid = 'SERVICE_AREA', _form = _grid + '_FORM';
	new GridBuilder( _grid , {
        controller:'blog/service_area',
        fields: [
            { 
            ...
            { header:'Deskripsi', renderer:'description' },
    ...
    new FormBuilder( _form , {
	    ...
	    fields: [
            ...
            { label:'URL', name:'url' },
            { label:'Logo', name:'logo', type:'select', datasource: {'graduation-cap':'Graduation', 'user':'User', 'book':'Book', 'rocket':'Roket', 'users':'Users', 'plug':'Plugin'} }
	    ]
  	});
</script>