...
<script type="text/javascript">
    var _grid = 'COUNTER_AREA', _form = _grid + '_FORM';
	new GridBuilder( _grid , {
        controller:'blog/counter_area',
        fields: [
            { 
    		...
    		{ header:'Jumlah', renderer:'counter' }
    	]
    });
    ...
    new FormBuilder( _form , {
	    ...
	    fields: [
            ...
            { label:'Jumlah', name:'counter', type:'number' },
            { label:'Delay', name:'delay', type:'select', datasource: {'.20s':'20s', '.40s':'40s', '.60s':'60s', '.80s':'80s', '.100s':'100s'} }
	    ]
  	});
</script>