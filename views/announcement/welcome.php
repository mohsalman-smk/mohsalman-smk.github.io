...
<script type="text/javascript">
	...
	tinymce.init({
      ...
      toolbar1: "insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image print preview forecolor backcolor emoticons",
      image_advtab: true,
      plugins: [
      ...
      images_upload_url: _BASE_URL + 'blog/welcome/do_upload',
	...
	function save() {
		...
		$.post(_BASE_URL + 'blog/welcome/save', values, function(response) {
