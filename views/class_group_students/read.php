...
<script type="text/javascript">
	 ...
	 new GridBuilder( _grid , {
		  controller:'academic/class_group_students',
		  fields: [
				{ 
				...
				{ header:_ACADEMIC_YEAR, renderer:'academic_year', sorting: false },
				{ header:'Kelas', renderer:'class_group', sorting: false },
				{ header:_IDENTITY_NUMBER, renderer:'identity_number', sorting: false },
