...
<section class="content">
	<div class="callout callout-info">
		...
		<ol>
			...
			<li>Isikan data dengan urutan <strong>[<?=$this->session->userdata('_identity_number')?>] [NAMA LENGKAP] [JENIS KELAMIN] [TANGGAL MASUK] [TANGGAL KELUAR] [HANDPHONE] [EMAIL] [ALAMAT JALAN]</strong></li>
