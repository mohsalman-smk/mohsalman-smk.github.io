                  ...
                  <form class="form-horizontal">
                     <div class="box-body">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-8">
                              <p class="form-control-static"><?=$query->parent_school_status == 'true' ? 'Ya':'Tidak'?></p>
                           </div>
                        </div>
                     </div>
                  </form>
                  ...
                  <form class="form-horizontal">
                     <div class="box-body">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-8">
                              <p class="form-control-static"><?=$query->gender=='M' ? 'Perempuan' : 'Laki-laki'?></p>
                           </div>
                        </div>
                        <div class="form-group">
                  ...
                  <form class="form-horizontal">
                     <div class="box-body">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-8">
                              <p class="form-control-static"><?=$query->institutions_lifter?></p>
                           </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-8">
                              <p class="form-control-static"><?=$query->salary_sources?></p>
                           </div>
                        </div>
                     </div>
                  </form>
