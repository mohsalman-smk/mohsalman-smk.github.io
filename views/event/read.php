...
<script type="text/javascript">
	var _grid = 'EVENT', _form = _grid + '_FORM';
    new GridBuilder( _grid , {
        controller:'blog/event',
        fields: [
            { 
            ...
            { 
                ...
                renderer:function(row) {
                    return Ahref(_BASE_URL + 'blog/event/create/' + row.id, 'Edit');
                },
                exclude_excel: true,
                sorting: false
            },
        ...
        can_add: false,
        resize_column: 5,
        extra_buttons: '<a class="btn btn-success btn-sm add" href="' + _BASE_URL + 'blog/event/create'+'" data-toggle="tooltip" data-placement="top" title="Add"><i class="fa fa-plus"></i></a>' 
    });
    ...
    function find_id( id ) {
        $.post(_BASE_URL + 'blog/event/find_id', {id:id}, function(response) {
            $('.modal-preview').modal({
                show:true
            });
