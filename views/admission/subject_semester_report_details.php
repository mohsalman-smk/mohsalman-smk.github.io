...
<script type="text/javascript">
	...
	new GridBuilder( _grid , {
        controller:'admission/subject_semester_report_details',
        fields: [
            {
        ...
        extra_buttons: '<a href="' + _BASE_URL + '/admission/subject_semester_report_settings" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" data-original-title="Kembali"><i class="fa fa-mail-forward"></i></a>', 
