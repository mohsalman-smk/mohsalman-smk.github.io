...
<script type="text/javascript">
    ...
    var grid_field = [
        ...
        { 
            ...
            renderer:function(row) {
                return Ahref('subject_semester_report_details/index/' + row.id, 'Pengaturan Mata Pelajaran', '<i class="fa fa-book"></i>', '_self');
            },
            exclude_excel: true,
            sorting: false
        },
	...
	new GridBuilder( _grid , {
        controller:'admission/subject_semester_report_settings',
        fields: grid_field,
        resize_column: 4
    });
