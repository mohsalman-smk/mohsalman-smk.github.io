...
function save2excel() {
	...
	var fileName = 'REKAP-NILAI-UJIAN-NASIONAL-' + (_SCHOOL_LEVEL >= 5 ? 'PMB':'PPDB') + '-TAHUN-' + $('#admission_year_id option:selected').text() + '-JALUR-PENDAFTARAN-' + $('#admission_type_id option:selected').text();
