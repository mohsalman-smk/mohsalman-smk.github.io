...
class Rooms extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['reference'] = $this->vars['rooms'] = true;
		$this->vars['options_buildings'] = json_encode($this->m_buildings->dropdown());
		$this->vars['content'] = 'rooms/read';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_rooms->get_where($keyword, $limit, $offset);
			$total_rows = $this->m_rooms->total_rows($keyword);
	...
	private function validation() {
		...
		$val->set_rules('building_id', 'Nama Gedung', 'trim|is_natural_no_zero|required');
		$val->set_rules('room_name', 'Nama Ruangan', 'trim|required');
		$val->set_rules('room_capacity', 'Kapasitas Ruangan', 'trim|is_natural_no_zero|required|max_length[3]');
