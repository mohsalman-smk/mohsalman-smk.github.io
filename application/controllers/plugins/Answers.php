...
class Answers extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['parent_data'] = json_encode($this->m_questions->dropdown());
		$this->vars['content'] = 'answers/read';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_answers->get_where($keyword, $limit, $offset);
			$total_rows = $this->m_answers->total_rows($keyword);
