...
class Residences extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model('m_residences');
		$this->pk = M_residences::$pk;
		$this->table = M_residences::$table;
	}
	...
	public function index() {
		...
		$this->vars['content'] = 'residences/read';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_residences->get_where($keyword, $limit, $offset);
			$total_rows = $this->m_residences->total_rows($keyword);
