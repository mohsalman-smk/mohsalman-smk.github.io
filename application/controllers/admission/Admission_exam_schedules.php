...
class Admission_exam_schedules extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['content'] = 'admission/admission_exam_schedules';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_admission_subject_settings->get_where($keyword, $limit, $offset, 'exam_schedule');
			$total_rows = $this->m_admission_subject_settings->total_rows($keyword, 'exam_schedule');
