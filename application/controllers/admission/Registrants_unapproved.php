...
class Registrants_unapproved extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['options'] = json_encode($options);
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_registrants_unapproved->get_where($keyword, $limit, $offset);
			$total_rows = $this->m_registrants_unapproved->total_rows($keyword);
	...
	private function fill_data() {
		...
		$fill_data['selection_result'] = $selection_result == 'unset' ? NULL : $selection_result;
