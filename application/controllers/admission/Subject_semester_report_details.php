...
class Subject_semester_report_details extends Admin_Controller {
	...
	public function index() {
		...
		if ($subject_setting_id) {
			...
			$this->vars['content'] = 'admission/subject_semester_report_details';
	...
	private function fill_data() {
		return [
			'subject_setting_id' => $this->input->post('subject_setting_id', true),
	...
	private function validation() {
		...
		$val->set_rules('subject_id', $this->session->userdata('_subject'), 'trim|required');
