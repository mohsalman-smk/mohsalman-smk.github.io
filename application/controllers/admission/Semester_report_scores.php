...
class Semester_report_scores extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'INPUT NILAI RAPOR';
		$this->vars['admission'] = $this->vars['semester_report_scores'] = true;
		...
		$this->vars['content'] = 'admission/semester_report_scores';
	...
	public function get_prospective_students() {
		if ($this->input->is_ajax_request()) {
			...
			// Get Prospective Students
			$query = $this->m_admission_subject_scores->get_subject_scores($admission_year_id, $admission_type_id, $major_id, 'semester_report', $limit, $offset);
			$total_rows = $this->m_admission_subject_scores->total_rows($admission_year_id, $admission_type_id, $major_id, 'semester_report');
