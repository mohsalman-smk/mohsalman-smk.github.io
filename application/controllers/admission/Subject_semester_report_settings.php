...
class Subject_semester_report_settings extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'Pengaturan Nilai Rapor Sekolah';
		$this->vars['admission'] = $this->vars['admission_settings'] = $this->vars['subject_semester_report_settings'] = true;
		...
		$this->vars['content'] = 'admission/subject_semester_report_settings';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_admission_subject_settings->get_where($keyword, $limit, $offset, 'semester_report');
			$total_rows = $this->m_admission_subject_settings->total_rows($keyword, 'semester_report');
