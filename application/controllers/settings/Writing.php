...
class Writing extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['options_categories'] = json_encode($this->m_post_categories->row_array());
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_settings->get_where($keyword, $limit, $offset, 'writing');
			$total_rows = $this->m_settings->total_rows($keyword, 'writing');
