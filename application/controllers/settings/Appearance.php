...
class Appearance extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'Pengaturan Tema';
		$this->vars['settings'] = $this->vars['appearance_settings'] = true;
		$this->vars['timezone_list'] = json_encode(timezone_list());
		$this->vars['content'] = 'settings/appearance';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_settings->get_where($keyword, $limit, $offset, 'appearance');
			$total_rows = $this->m_settings->total_rows($keyword, 'appearance');
	...
	/**
	 ...
	 private function image_resize($source, $file_name, $setting_variable = 'favicon') {
	 	$settings = [
	 		'favicon_width' => 32,
	 		'favicon_height' => 32,
	 		'about_image_width' => 650,
	 		'about_image_height' => 328,
	 		'header_1_image_width' => 1920,
	 		'header_1_image_height' => 634,
	 		'header_2_image_width' => 1920,
	 		'header_2_image_height' => 634,
	 		'header_3_image_width' => 1920,
	 		'header_3_image_height' => 634
	 	];
