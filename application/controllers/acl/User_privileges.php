...
class User_privileges extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['acl'] = $this->vars['user_privileges'] = true;
	...
	private function validation() {
		...
		$val->set_rules('user_group_id', 'User Group', 'trim|required|is_natural_no_zero');
		$val->set_rules('module_id', 'Module', 'trim|required|is_natural_no_zero');
