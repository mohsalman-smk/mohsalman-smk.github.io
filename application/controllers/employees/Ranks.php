...
class Ranks extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model('m_ranks');
		$this->pk = M_ranks::$pk;
		$this->table = M_ranks::$table;
	}
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_ranks->get_where($keyword, $limit, $offset);
			$total_rows = $this->m_ranks->total_rows($keyword);
