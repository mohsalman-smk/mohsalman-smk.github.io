...
class Laboratory_skills extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model('m_laboratory_skills');
		$this->pk = M_laboratory_skills::$pk;
		$this->table = M_laboratory_skills::$table;
	}
	...
	public function index() {
		...
		$this->vars['content'] = 'laboratory_skills/read';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_laboratory_skills->get_where($keyword, $limit, $offset);
			$total_rows = $this->m_laboratory_skills->total_rows($keyword);
