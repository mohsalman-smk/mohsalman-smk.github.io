...
class Employment_status extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model('m_employment_status');
		$this->pk = M_employment_status::$pk;
		$this->table = M_employment_status::$table;
	}
	...
	public function index() {
		...
		$this->vars['content'] = 'employment_status/read';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_employment_status->get_where($keyword, $limit, $offset);
			$total_rows = $this->m_employment_status->total_rows($keyword);
