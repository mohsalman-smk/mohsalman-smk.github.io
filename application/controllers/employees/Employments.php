...
class Employments extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model('m_employments');
		$this->pk = M_employments::$pk;
		$this->table = M_employments::$table;
	}
	...
	public function index() {
		...
		$this->vars['content'] = 'employments/read';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_employments->get_where($keyword, $limit, $offset);
			$total_rows = $this->m_employments->total_rows($keyword);
