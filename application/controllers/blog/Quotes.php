...
class Quotes extends Admin_Controller {
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_quotes->get_where($keyword, $limit, $offset);
			$total_rows = $this->m_quotes->total_rows($keyword);
	...
	private function validation() {
		...
		$val->set_rules('quote_by', 'Kutipan Oleh', 'trim|required');
