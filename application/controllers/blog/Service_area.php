...
class Service_area extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model('m_service_area');
		$this->pk = M_service_area::$pk;
		$this->table = M_service_area::$table;
	}
	...
	public function index() {
		$this->vars['title'] = 'Service Area';
		$this->vars['blog'] = $this->vars['service_area'] = true;
		$this->vars['content'] = 'service_area/read';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_service_area->get_where($keyword, $limit, $offset);
			$total_rows = $this->m_service_area->total_rows($keyword);
	...
	private function validation() {
		...
		$val->set_rules('logo', 'Logo', 'trim|required');
