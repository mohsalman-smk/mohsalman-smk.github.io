...
class Counter_area extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model('m_counter_area');
		$this->pk = M_counter_area::$pk;
		$this->table = M_counter_area::$table;
	}
	...
	public function index() {
		$this->vars['title'] = 'COUNTER AREA';
		$this->vars['blog'] = $this->vars['counter_area'] = true;
		$this->vars['content'] = 'counter_area/read';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_counter_area->get_where($keyword, $limit, $offset);
			$total_rows = $this->m_counter_area->total_rows($keyword);
	...
	private function validation() {
		...
		$val->set_rules('counter', 'Jumlah', 'trim|required');
		$val->set_rules('delay', 'Delay', 'trim|required');
