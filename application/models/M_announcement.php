...
class M_announcement extends CI_Model {
	...
	public function total_rows($keyword = '') {
		...
		return $this->db->count_all_results('announcement x1');
	}

	/**
	 * Get announcement for RSS Feed
	 * @return Resource
	 */
	...
	public function get_archives($year) {
		...
		return $this->db->get('announcement x1');
	}
	 ...
	 * @return Resource
	 */
	public function get_recent_announcement($limit = 10) {
		$this->db->select('
			x1.id
		  , x1.post_title
	...
	/**
	 * Get Popular announcement
	 * @access  Public
	 * @param Int
	 * @return Resource
	 */
	public function get_popular_announcement($limit = 6) {
		$this->db->select('
			x1.id
		  , x1.post_title
		  , LEFT(x1.created_at, 10) AS created_at
	...
	/**
	 * Get recent added announcement / for dashboard
	 * @access  Public
	 * @return Resource
	 */
	public function get_recent_added_announcement() {
	 ...
	 * @return Resource
	 */
	public function get_random_announcement($limit = 10) {
		$this->db->select('
			x1.id
		  , x1.post_title
		  , LEFT(x1.created_at, 10) AS created_at
	 ...
	 * @return 	Query
	 */
	public function get_related_announcement($categories = '', $id) {
	 ...
	 * @return 	Resource
	 */
	public function get_archive_announcement($year, $month) {
		$this->db->select('
			x1.id
			, x1.post_title
	 ...
	 * @return Resource
	 */
	public function more_announcement($category_slug = '', $offset = 0) {
		$id = 0;
		$query = $this->db
			->select('id')
		...
		$this->db->like('x1.post_categories', $id);
		$this->db->group_end();
		return $this->db->get(self::$table.' x1', 7, $offset);
	}
	 ...
	 * @return 	Resource
	 */
	public function more_archive_announcement($offset = 0, $year, $month) {
	...
	/**
	 * More announcement by Tags
	 * @param String
	 * @param Int
	 * @return Resource
	 */
	public function more_announcement_by_tag($tag = '', $offset = 0) {
		$this->db->select('x1.id, x1.post_title, x1.post_content, LEFT(x1.created_at, 10) AS created_at, x1.post_image, x1.post_slug, x1.post_counter');
		$this->db->where('x1.post_type', 'post');
		$this->db->where('x1.is_deleted', 'false');
		$this->db->where('x1.post_status', 'publish');
