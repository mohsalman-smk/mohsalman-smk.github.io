...
$route['event/(:num)/(:any)'] = 'public/readmores';
$route['announcement/(:num)/(:any)'] = 'public/readmoress';
$route['feed'] = 'public/feed';
$route['sambutan-rektor'] = 'public/sambutan_kepala_sekolah';
$route['sambutan-ketua'] = 'public/sambutan_kepala_sekolah';
$route['sambutan-direktur'] = 'public/sambutan_kepala_sekolah';
...
$route['pdf-formulir-penerimaan-peserta-didik-baru/([0-9]{4})-([0-9]{2})-([0-9]{2})/([0-9]{9})'] = 'public/admission_form/create_pdf';
...
$route['pdf-formulir-penerimaan-mahasiswa-baru/([0-9]{4})-([0-9]{2})-([0-9]{2})/([0-9]{9})'] = 'public/admission_form/create_pdf';
